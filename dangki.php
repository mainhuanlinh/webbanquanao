...
$db = mysqli_connect('localhost', 'root', '', 'db_doan');

// REGISTER USER
if (isset($_POST['reg_user'])) {
  // receive all input values from the form
  $username = mysqli_real_escape_string($db, $_POST['username']);
  $email = mysqli_real_escape_string($db, $_POST['userpass']);
  ...
  $user_check_query = "SELECT * FROM tb_loginuser WHERE username='$username' OR userpass='$userpass' LIMIT 1";
